...
the default remains limited to the two recorded edge periods. The first eight
live full-history batches atomically committed every month of 1954–1961,
moving the local checkpoint from 92 of 920 to 188 of 920 complete months. The
next bounded batch begins with January 1962.
